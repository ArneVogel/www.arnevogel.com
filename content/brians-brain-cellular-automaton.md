...
<div class="input_with_appended_unit">
Simulation settings: Spawn: <input value="2" id="b"></input><span>B</span> Wrapping: <input class="checkbox" id="wrap" type="checkbox"><button class="btn" onclick="gameChange()">Apply</button>
</div>
<div class="input_with_appended_unit">
